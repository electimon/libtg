...
tlo_t * tl_invokeAfterMsg(buf_t arg_Type, long arg_msg_id, buf_t arg_query);
tlo_t * tl_invokeAfterMsgs(buf_t arg_Type, long *arg_msg_ids, int len_arg_msg_ids, buf_t arg_query);
tlo_t * tl_initConnection(buf_t arg_Type, int arg_api_id, const char * arg_device_model, const char * arg_system_version, const char * arg_app_version, const char * arg_system_lang_code, const char * arg_lang_pack, const char * arg_lang_code, InputClientProxy arg_proxy, JSONValue arg_params, buf_t arg_query);
tlo_t * tl_invokeWithLayer(buf_t arg_Type, int arg_layer, buf_t arg_query);
tlo_t * tl_invokeWithoutUpdates(buf_t arg_Type, buf_t arg_query);
tlo_t * tl_invokeWithMessagesRange(buf_t arg_Type, MessageRange arg_range, buf_t arg_query);
tlo_t * tl_invokeWithTakeout(buf_t arg_Type, long arg_takeout_id, buf_t arg_query);
tlo_t * tl_invokeWithBusinessConnection(buf_t arg_Type, const char * arg_connection_id, buf_t arg_query);
tlo_t * tl_invokeWithGooglePlayIntegrity(buf_t arg_Type, const char * arg_nonce, const char * arg_token, buf_t arg_query);
tlo_t * tl_invokeWithApnsSecret(buf_t arg_Type, const char * arg_nonce, const char * arg_secret, buf_t arg_query);
