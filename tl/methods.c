...
buf_t tl_resPQ(int128 nonce_, int128 server_nonce_, const char * pq_, long *server_public_key_fingerprints_, int server_public_key_fingerprints_len)
{
	...
	{
			buf = buf_cat(buf, nonce_);
	}
	//parse argument server_nonce (int128)
	{
			buf = buf_cat(buf, server_nonce_);
	}
...
buf_t tl_dh_gen_ok(int128 nonce_, int128 server_nonce_, int128 new_nonce_hash1_)
{
	...
	{
			buf = buf_cat(buf, new_nonce_hash1_);
	}
	return buf;
}
...
buf_t tl_dh_gen_retry(int128 nonce_, int128 server_nonce_, int128 new_nonce_hash2_)
{
	...
	{
			buf = buf_cat(buf, new_nonce_hash2_);
	}
	return buf;
}
...
buf_t tl_dh_gen_fail(int128 nonce_, int128 server_nonce_, int128 new_nonce_hash3_)
{
	...
	{
			buf = buf_cat(buf, new_nonce_hash3_);
	}
	return buf;
}
...
buf_t tl_rpc_result(long req_msg_id_, X *result_)
{
...
buf_t tl_null()
{
	buf_t buf = buf_add_ui32(0x56730bcc);
	return buf;
}
...
buf_t tl_inputMediaPaidMedia(long stars_amount_, InputMedia *extended_media_, int extended_media_len)
{
	buf_t buf = buf_add_ui32(0xaa661fc3);
...
buf_t tl_channel(bool creator_, bool left_, bool broadcast_, bool verified_, bool megagroup_, bool restricted_, bool signatures_, bool min_, bool scam_, bool has_link_, bool has_geo_, bool slowmode_enabled_, bool call_active_, bool call_not_empty_, bool fake_, bool gigagroup_, bool noforwards_, bool join_to_send_, bool join_request_, bool forum_, bool stories_hidden_, bool stories_hidden_min_, bool stories_unavailable_, long id_, long access_hash_, const char * title_, const char * username_, ChatPhoto *photo_, int date_, RestrictionReason *restriction_reason_, int restriction_reason_len, ChatAdminRights *admin_rights_, ChatBannedRights *banned_rights_, ChatBannedRights *default_banned_rights_, int participants_count_, Username *usernames_, int usernames_len, int stories_max_id_, PeerColor *color_, PeerColor *profile_color_, EmojiStatus *emoji_status_, int level_)
{
	buf_t buf = buf_add_ui32(0x0aadfc8f);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
	//parse argument creator (true)
...
buf_t tl_messageMediaDocument(bool nopremium_, bool spoiler_, bool video_, bool round_, bool voice_, Document *document_, Document *alt_document_, int ttl_seconds_)
{
	buf_t buf = buf_add_ui32(0x4cf4d72d);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
	...
	//parse argument alt_document (Document)
	if (alt_document_)
	{
		buf = buf_cat(buf, *alt_document_);
		*flag1 |= (1 << 5);
	}
	//parse argument ttl_seconds (int)
	if (ttl_seconds_)
...
buf_t tl_messageMediaGiveaway(bool only_new_subscribers_, bool winners_are_visible_, long *channels_, int channels_len, const char * *countries_iso2_, int countries_iso2_len, const char * prize_description_, int quantity_, int months_, int until_date_)
{
	buf_t buf = buf_add_ui32(0xdaad85b0);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
buf_t tl_messageMediaGiveawayResults(bool only_new_subscribers_, bool refunded_, long channel_id_, int additional_peers_count_, int launch_msg_id_, int winners_count_, int unclaimed_count_, long *winners_, int winners_len, int months_, const char * prize_description_, int until_date_)
{
	buf_t buf = buf_add_ui32(0xc6991068);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
	//parse argument only_new_subscribers (true)
...
{
	buf_t buf = buf_add_ui32(0x332ba9ed);
	return buf;
}

buf_t tl_messageActionGiveawayResults(int winners_count_, int unclaimed_count_)
{
	buf_t buf = buf_add_ui32(0x2a9fadc5);
	//parse argument winners_count (int)
	{
		buf = buf_cat(buf, buf_add_ui32(winners_count_));
	}
...
{
	buf_t buf = buf_add_ui32(0xcc997720);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
	//parse argument blocked (true)
...
buf_t tl_documentAttributeVideo(bool round_message_, bool supports_streaming_, bool nosound_, double duration_, int w_, int h_, int preload_prefix_size_, double video_start_ts_)
{
	buf_t buf = buf_add_ui32(0x17399fad);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
buf_t tl_chatInviteExported(bool revoked_, bool permanent_, bool request_needed_, const char * link_, long admin_id_, int date_, int start_date_, int expire_date_, int usage_limit_, int usage_, int requested_, const char * title_)
{
	buf_t buf = buf_add_ui32(0x0ab4a819);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
buf_t tl_chatInvite(bool channel_, bool broadcast_, bool public_, bool megagroup_, bool request_needed_, bool verified_, bool scam_, bool fake_, const char * title_, const char * about_, Photo *photo_, int participants_count_, User *participants_, int participants_len, int color_)
{
	buf_t buf = buf_add_ui32(0xcde0ec40);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
buf_t tl_botInfo(bool has_preview_medias_, long user_id_, const char * description_, Photo *description_photo_, Document *description_document_, BotCommand *commands_, int commands_len, BotMenuButton *menu_button_)
{
	buf_t buf = buf_add_ui32(0x8f300b57);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
buf_t tl_channelParticipant(long user_id_, int date_)
{
	buf_t buf = buf_add_ui32(0xc00c07c0);
	//parse argument user_id (long)
	{
		buf = buf_cat(buf, buf_add_ui64(user_id_));
	}
...
buf_t tl_channelParticipantSelf(bool via_request_, long user_id_, long inviter_id_, int date_)
{
	buf_t buf = buf_add_ui32(0x35a8bfa7);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
{
	buf_t buf = buf_add_ui32(0xbdedf566);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
{
	buf_t buf = buf_add_ui32(0x4f2b9479);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
	//parse argument min (true)
...
buf_t tl_payments_giveawayInfoResults(bool winner_, bool refunded_, int start_date_, const char * gift_code_slug_, int finish_date_, int winners_count_, int activated_count_)
{
	buf_t buf = buf_add_ui32(0x00cd5570);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
buf_t tl_boost(bool gift_, bool giveaway_, bool unclaimed_, const char * id_, long user_id_, int giveaway_msg_id_, int date_, int expires_, const char * used_gift_slug_, int multiplier_)
{
	buf_t buf = buf_add_ui32(0x2a1c8c71);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
buf_t tl_broadcastRevenueBalances(long current_balance_, long available_balance_, long overall_revenue_)
{
	buf_t buf = buf_add_ui32(0x8438f1c6);
...
buf_t tl_payments_starsStatus(long balance_, StarsTransaction *history_, int history_len, const char * next_offset_, Chat *chats_, int chats_len, User *users_, int users_len)
{
	buf_t buf = buf_add_ui32(0x8cf4ee60);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
	//parse argument balance (long)
...
buf_t tl_messages_report(InputPeer *peer_, int *id_, int id_len, ReportReason *reason_, const char * message_)
{
	buf_t buf = buf_add_ui32(0x8953ab4e);
	//parse argument peer (InputPeer)
	{
		buf = buf_cat(buf, *peer_);
	}
...
buf_t tl_messages_exportChatInvite(bool legacy_revoke_permanent_, bool request_needed_, InputPeer *peer_, int expire_date_, int usage_limit_, const char * title_)
{
	buf_t buf = buf_add_ui32(0xa02ce5d5);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
buf_t tl_messages_setChatAvailableReactions(InputPeer *peer_, ChatReactions *available_reactions_, int reactions_limit_)
{
	buf_t buf = buf_add_ui32(0x5a150bd4);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
	//parse argument peer (InputPeer)
...
{
	buf_t buf = buf_add_ui32(0x1f69b606);
	//parse argument channel (InputChannel)
	{
		buf = buf_cat(buf, *channel_);
	}
...
{
	buf_t buf = buf_add_ui32(0x18afbc93);
	//parse argument channel (InputChannel)
	{
		buf = buf_cat(buf, *channel_);
	}
...
buf_t tl_payments_getStarsTransactions(bool inbound_, bool outbound_, bool ascending_, InputPeer *peer_, const char * offset_, int limit_)
{
	buf_t buf = buf_add_ui32(0x97938d5a);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
...
{
	buf_t buf = buf_add_ui32(0x02bb731d);
	//parse argument flags ((null))
	ui32_t *flag1 = (ui32_t *)(&buf.data[buf.size]);
	buf = buf_cat(buf, buf_add_ui32(0));
	//parse argument form_id (long)
...
buf_t tl_stories_report(InputPeer *peer_, int *id_, int id_len, ReportReason *reason_, const char * message_)
{
	buf_t buf = buf_add_ui32(0x1923fa8c);
	//parse argument peer (InputPeer)
	{
		buf = buf_cat(buf, *peer_);
	}
